                ...
                <div class="modal-body">
                    <div class="row xrow">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" id="name_entry" class="form-control" required maxlength="250" value="name1" />
                        </div>
                    ...
                    <div class="row xrow">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" id="descs_entry" class="form-control" required maxlength="20" value="descs1"/>
                        </div>
                    </div>
                    <div class="row xrow">
                        <div class="input-group input-group-sm">
                            <span class="input-group-addon span-addon-pw" style="color: #286090; text-align: left;">Model - Year : </span>
                            <input type="text" id="model_year_entry" class="form-control" required maxlength="20" value="model 5" />
                    ...
                    <div class="row xrow">
                        <div class="input-group  input-group-sm">
                            ...
                            <input type="text" id="color_entry" class="form-control" required maxlength="20" value="yellow"/>
                        </div>
                    </div>
                    ...
                    <div class="row xrow">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" id="plate_no_entry" class="form-control" placeholder="" required maxlength="20" value="plate1" />
                        </div>
                    </div>
                    <div class="row xrow">
                        <div class="input-group input-group-sm">
                            <span class="input-group-addon span-addon-pw" style="color: #286090; text-align: left;">Insurance Policy No. : </span>
                            <input type="text" id="insurance_po_entry" class="form-control" placeholder="" required maxlength="20" value="insu" />
                        </div>
                    </div>
                    <div class="row xrow">
                        <div class="input-group input-group-sm">
                            <span class="input-group-addon span-addon-pw" style="color: #286090; text-align: left;">Seater Capacity : </span>
                            <input type="text" id="seater_cap_entry" class="form-control money-align" placeholder="" required maxlength="20" value="5" />
                        </div>
                    </div>
                    <div class="row xrow">
                        <div class="input-group input-group-sm">
                            <span class="input-group-addon span-addon-pw" style="color: #286090; text-align: left;">Fuel Type : </span>
                            <input type="text" id="fuel_type_entry" class="form-control" placeholder="" required maxlength="20" value="lll" />
                        </div>
                    </div>
                    <div class="row xrow">
                        <div class="input-group input-group-sm">
                            <span class="input-group-addon span-addon-pw" style="color: #286090; text-align: left;">Location : </span>
                            <input type="text" id="location_entry" class="form-control" placeholder="" required maxlength="20" value="cebu" />
                        </div>
                    </div>
                    <div class="row xrow">
                        <div class="input-group input-group-sm">
                            <span class="input-group-addon span-addon-pw" style="color: #286090; text-align: left;">Distance Unit : </span>
                            <input type="text" id="distance_unit_entry" class="form-control" placeholder="" required maxlength="20" value="km"/>
                        </div>
                    </div>
                    <div class="row xrow">
                        <div class="input-group input-group-sm">
                            <span class="input-group-addon span-addon-pw" style="color: #286090; text-align: left;">Fuel Unit : </span>
                            <input type="text" id="fuel_unit_entry" class="form-control" placeholder="" required maxlength="20" value="litre" />
                        </div>
                    </div>
